...
def train(env, policy, optimizer, discount_factor, ppo_steps, ppo_clip):
    ...
    # Handle new Gym API: env.reset() returns (obs, info)
    ...
    while not done:
        ...
        # Handle new Gym API: env.step() returns (obs, reward, terminated, truncated, info)
...
# --- Gym API compatibility: env.reset() and env.step() handled in train/evaluate ---
MAX_EPISODES = 500
